...
/**
 * Class which handles the error codes when executing an operation. The class uses the Singleton
 * pattern.
...
public final class ErrorCodeManager {
     ...
     * @return boolean value corresponding if there was an error or not
     */
